...
{title:"PGR",id:'1',company:'cnpj',worker:{cargo:'',setor:'',cargoDev:'',setorDev:''},data:[
  {group:'Limpeza e organização do local de trabalho',id:'1',questions:[
    {action:{yes:{risk:['8b5cb64b-c5f5-406e-b06f-1ee19e1be34c','00d0fc0e-1543-428f-a405-9f7e46e80666']},no:0,na:0},text:'As seções (Setores/Áreas/Departamentos) e os processos estão localizados de forma a facilitar o trabalho?',id:'1.2'},
...
export default function App({navigation,route}) {
  ...
  return (
    <>
      ...
      {answers?.data && <Card.BottomSheet answers={answers} riskAnswer={riskAnswer} risk={risk} sheetRef={sheetRef} dispatch={dispatch}/>}
    </>
